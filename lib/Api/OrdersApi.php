...
class OrdersApi
{
     ...
     * @throws \EzzeSiftuz\OrdersV3\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EzzeSiftuz\OrdersV3\Model\PartnerOrderList
     */
     ...
     * @throws \EzzeSiftuz\OrdersV3\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EzzeSiftuz\OrdersV3\Model\PartnerOrderList, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\EzzeSiftuz\OrdersV3\Model\PartnerOrderList';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EzzeSiftuz\OrdersV3\Model\PartnerOrderList',
     ...
     * @throws \EzzeSiftuz\OrdersV3\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EzzeSiftuz\OrdersV3\Model\PartnerOrder
     */
     ...
     * @throws \EzzeSiftuz\OrdersV3\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EzzeSiftuz\OrdersV3\Model\PartnerOrder, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPartnerOrderBySalesOrderIdWithHttpInfo($sales_order_id)
    {
        $returnType = '\EzzeSiftuz\OrdersV3\Model\PartnerOrder';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EzzeSiftuz\OrdersV3\Model\PartnerOrder',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
